...
#define create_game_data ((PFN_create_game_data)PF_MEM(0x404198))
...
#define datafile_callback_slow ((PFN_datafile_callback_slow)PF_MEM(0x407bf0))
/* delete_profile  VA=0x41a8a8  cu=F:\projects\icytower\trunk\source\profile.c */
/* prototype: void delete_profile(char *) */
#define delete_profile ((PFN_delete_profile)PF_MEM(0x41a8a8))
...
#define draw_menu ((PFN_draw_menu)PF_MEM(0x41767c))
...
#define draw_profile_selector ((PFN_draw_profile_selector)PF_MEM(0x418cd4))
/* draw_progress_bar  VA=0x407a08  cu=F:\projects\icytower\trunk\source\main.c */
/* prototype: void draw_progress_bar() */
#define draw_progress_bar ((PFN_draw_progress_bar)PF_MEM(0x407a08))
...
#define draw_replay_selector ((PFN_draw_replay_selector)PF_MEM(0x41be58))
...
#define draw_results ((PFN_draw_results)PF_MEM(0x4076c0))
/* draw_reward  VA=0x4070fc  cu=F:\projects\icytower\trunk\source\main.c */
/* prototype: void draw_reward(BITMAP *) */
#define draw_reward ((PFN_draw_reward)PF_MEM(0x4070fc))
...
#define draw_scroller ((PFN_draw_scroller)PF_MEM(0x41f0ec))
...
#define dumpHTTPResponse ((PFN_dumpHTTPResponse)PF_MEM(0x405e2c))
/* end_game  VA=0x40e110  cu=F:\projects\icytower\trunk\source\main.c */
/* prototype: void end_game() */
#define end_game ((PFN_end_game)PF_MEM(0x40e110))
...
#define enter_hisc_table ((PFN_enter_hisc_table)PF_MEM(0x405790))
...
#define fldads_dump_local_cache ((PFN_fldads_dump_local_cache)PF_MEM(0x403c84))
...
#define fldads_get_local_cache_name ((PFN_fldads_get_local_cache_name)PF_MEM(0x403c44))
...
#define fldads_get_local_filename_from_url ((PFN_fldads_get_local_filename_from_url)PF_MEM(0x403d4c))
...
#define fldads_get_random_ad ((PFN_fldads_get_random_ad)PF_MEM(0x403af8))
...
#define fldads_load_cache_from_csv ((PFN_fldads_load_cache_from_csv)PF_MEM(0x403d68))
...
#define fldads_update_cache ((PFN_fldads_update_cache)PF_MEM(0x403fa4))
...
#define fldads_update_local_adimg ((PFN_fldads_update_local_adimg)PF_MEM(0x403ebc))
/* flush_data  VA=0x41e8a8  cu=F:\projects\icytower\trunk\source\savepng.c */
/* prototype: void flush_data(png_structp) */
#define flush_data ((PFN_flush_data)PF_MEM(0x41e8a8))
...
#define for_each_directory ((PFN_for_each_directory)PF_MEM(0x40cbc0))
...
#define generate_checksum ((PFN_generate_checksum)PF_MEM(0x404a50))
...
#define generate_options_checksum ((PFN_generate_options_checksum)PF_MEM(0x4181cc))
...
#define getSampleFromOggDatafile ((PFN_getSampleFromOggDatafile)PF_MEM(0x40ca2c))
/* getSocketError  VA=0x405e90  cu=F:\projects\icytower\trunk\source\httpget.c */
/* prototype: int getSocketError() */
#define getSocketError ((PFN_getSocketError)PF_MEM(0x405e90))
...
#define get_adcache_dir ((PFN_get_adcache_dir)PF_MEM(0x4039a4))
...
#define get_character_dir ((PFN_get_character_dir)PF_MEM(0x403a84))
...
#define get_profile_dir_for_profile ((PFN_get_profile_dir_for_profile)PF_MEM(0x403a44))
...
#define get_replay_property ((PFN_get_replay_property)PF_MEM(0x41e244))
...
#define get_url_filename ((PFN_get_url_filename)PF_MEM(0x403d20))
/* get_version_str  VA=0x406960  cu=F:\projects\icytower\trunk\source\main.c */
/* prototype: char * get_version_str() */
#define get_version_str ((PFN_get_version_str)PF_MEM(0x406960))
...
#define handle_menu ((PFN_handle_menu)PF_MEM(0x417d24))
...
#define handle_player_collision_combo ((PFN_handle_player_collision_combo)PF_MEM(0x408358))
...
#define init_game ((PFN_init_game)PF_MEM(0x40e7dc))
...
#define init_scroller ((PFN_init_scroller)PF_MEM(0x41f278))
...
#define init_star_field ((PFN_init_star_field)PF_MEM(0x41f52c))
...
#define is_custom_replay ((PFN_is_custom_replay)PF_MEM(0x406b3c))
...
#define new_srand ((PFN_new_srand)PF_MEM(0x406a04))
...
#define open_web_browser ((PFN_open_web_browser)PF_MEM(0x40e510))
...
#define profile_data_page_advanced ((PFN_profile_data_page_advanced)PF_MEM(0x419284))
...
#define profile_data_page_basic ((PFN_profile_data_page_basic)PF_MEM(0x4193d0))
...
#define profile_data_page_extra ((PFN_profile_data_page_extra)PF_MEM(0x419650))
...
#define read_data ((PFN_read_data)PF_MEM(0x4068c4))
...
#define read_data_memory ((PFN_read_data_memory)PF_MEM(0x406738))
/* read_line  VA=0x401460  cu=F:\projects\icytower\trunk\source\beta.c */
/* prototype: void read_line(char *, it_orig_FILE *) */
#define read_line ((PFN_read_line)PF_MEM(0x401460))
...
#define really_load_png ((PFN_really_load_png)PF_MEM(0x4061b0))
...
#define really_save_png ((PFN_really_save_png)PF_MEM(0x41e8b0))
...
#define rebuild_profile_list ((PFN_rebuild_profile_list)PF_MEM(0x40c758))
...
#define select_profile ((PFN_select_profile)PF_MEM(0x41acc0))
...
#define set_current_avatar ((PFN_set_current_avatar)PF_MEM(0x406ce4))
...
#define set_next_rank_message ((PFN_set_next_rank_message)PF_MEM(0x418b24))
...
#define stopMenuMusic ((PFN_stopMenuMusic)PF_MEM(0x406f5c))
...
#define write_data ((PFN_write_data)PF_MEM(0x41f074))
