...
#define create_particle ((PFN_create_particle)PF_MEM(0x418490))
...
#define new_rand ((PFN_new_rand)PF_MEM(0x406984))
/* ok_to_play  VA=0x406a50  cu=F:\projects\icytower\trunk\source\main.c */
/* prototype: int ok_to_play() */
#define ok_to_play ((PFN_ok_to_play)PF_MEM(0x406a50))
...
#define update_particle ((PFN_update_particle)PF_MEM(0x41843c))
